...
# Récupère le chemin absolu du répertoire contenant le script actuel
...
class Shazam(QMainWindow):
    ...
    def create_controls(self):
        ...
        # Load the image 
        image_path = os.path.join(BASE_DIR, "images", "song_icon.png")
    ...
    def mix_songs(self):
        if hasattr(self, 'first_song_path') and hasattr(self, 'second_song_path'):
            ...
            mixed_song_path = os.path.join(BASE_DIR, "mixed_song")
    ...
    def get_base_folder(self):
        path = os.path.join(BASE_DIR, "Task _5_ Data")
        return path  # Path to the folder containing the team folders
